        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Endereco_Bairro = table.Column<string>(type: "varchar(150)", nullable: true),
                    Endereco_Cidade = table.Column<string>(type: "varchar(150)", nullable: true),
                    Endereco_Estado = table.Column<string>(type: "varchar(50)", nullable: true),
                    NumeroTelefone = table.Column<string>(type: "varchar(15)", nullable: true),
